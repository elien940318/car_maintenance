...
> 상세: [`sdd/02_plan/03_architecture/tech_stack_decision.md`](02_plan/03_architecture/tech_stack_decision.md)
...
# 2. Prisma 초기화
cd apps/api && npx prisma init --datasource-provider sqlite
